...
def main():
    ...
    parser.add_argument('--input-size', type=int, default=1024, help='signal input size')
    ...
    parser.add_argument('--n-classes', '-n', type=int, default=1, help='number of classes in output')
    parser.add_argument('--learning-rate', '-lr', type=float, default=0.00001, help='initial learning rate')
    parser.add_argument('--fake-input', action='store_true', default=False, help='debug with 1 batch training')
    parser.add_argument('--subsample', action='store_true', default=False, help='subsample signal')
