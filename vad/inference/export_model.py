...
def main():
    ...
    parser.add_argument('--model-dir', type=str, help='pretrained model directory')
    ...
    parser.add_argument('--n-classes', '-n', type=int, default=1, help='number of classes')
    ...
    feature_spec = {
        'features_input': tf.compat.v1.placeholder(dtype=tf.float32, shape=[1, FEAT_SIZE[1], FEAT_SIZE[0]])
    }
